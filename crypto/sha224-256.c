/* 
 * ESP8266 SHA-2 RFC4634 adapted implementation
 ...
 */
int             ICACHE_FLASH_ATTR
SHA224Input (SHA224Context * context, const uint8_t * message_array, unsigned int length)
{
 ...
 */
int             ICACHE_FLASH_ATTR
SHA224FinalBits (SHA224Context * context, const uint8_t message_bits, unsigned int length)
{
 ...
 */
int             ICACHE_FLASH_ATTR
SHA256Input (SHA256Context * context, const uint8_t * message_array, unsigned int length)
{
    if (!length)
        return shaSuccess;
 ...
 */
int             ICACHE_FLASH_ATTR
SHA256FinalBits (SHA256Context * context, const uint8_t message_bits, unsigned int length)
{
    uint8_t         masks[8] = {
 ...
 */
static int      ICACHE_FLASH_ATTR
SHA224_256ResultN (SHA256Context * context, uint8_t Message_Digest[], int HashSize)
{
    int             i;
